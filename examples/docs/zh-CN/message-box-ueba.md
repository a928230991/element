...
<template>
  ...
  <el-button
    ...
    <el-button
      size="small"
      type="warning"
      @click="openType('warning')"
      >warning</el-button
    >
    <el-button
      size="small"
      type="danger"
      @click="openType('error')"
      >error</el-button
    >
</template>
...
<script>
  export default {
    methods: {
      ...
      openType(type) {
        this.$confirm(
          '强提醒文字强提醒文字强提醒文字强提醒文字强提醒文字强提醒文字',
          '提示',
          {
...
<template>
  <el-button type="text" @click="open">点击打开 Message Box</el-button>
   <el-button
      size="small"
      type="success"
      @click="handleType('success')"
      >success</el-button
    >
    <el-button
      size="small"
      type="info"
      @click="handleType('info')"
      >info</el-button
    >
    <el-button
      size="small"
      type="warning"
      @click="handleType('warning')"
      >warning</el-button
    >
    <el-button
      size="small"
      type="danger"
      @click="handleType('error')"
      >error</el-button
    >
</template>
